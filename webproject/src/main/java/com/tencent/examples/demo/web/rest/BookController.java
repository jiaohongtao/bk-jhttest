...
public class BookController extends BaseController {
	...
	public @ResponseBody
	String findbooksByNameAndID(String name, Integer id, Integer limit, Integer offset) {
	...
	public @ResponseBody
	String getBooksByLikeName(String likename) {
	...
	public @ResponseBody
	String deleteByBooks(String data) {
	...
	public @ResponseBody
	String getAll(Integer limit, Integer offset, String search, String bookname, Integer bookid) {
